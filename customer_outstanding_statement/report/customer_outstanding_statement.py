...
class CustomerOutstandingStatement(models.AbstractModel):
    ...
    def render_html(self, docids, data):
        ...
        # return self.env['ir.actions.report'].render(
        #     'customer_outstanding_statement.statement', data=docargs)
        return self.env.ref(
            'customer_outstanding_statement.action_print_customer_outstanding_statement'
        ).render(docargs['doc_ids'], data=docargs)
